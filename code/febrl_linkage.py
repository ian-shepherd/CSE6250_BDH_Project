...
def extract_features(df, links):
    ...
    c.string(
        ...
        "surname_soundex",
        method="jarowinkler",
        label="y_surname_soundex",
    )
    c.string(
        "surname_nysiis",
        "surname_nysiis",
        method="jarowinkler",
        label="y_surname_nysiis",
    )
...
def main(local=False):
    ...
    pl.show_plot(
        df_precision,
        "Hyperparameter - Precision - Scheme A",
        "precision",
        "precision_schemeA_1.png",
    )
    pl.show_plot(
        df_sensitivity,
        "Hyperparameter - Sensitivity - Scheme A",
        "sensitivity",
        "sensitivity_schemeA_1.png",
    )
    pl.show_plot(
        df_fscore,
        "Hyperparameter - FScore - Scheme A",
        "fscore",
        "fscore_schemeA_1.png",
    )
    pl.show_plot(
        df_nb_false,
        "Hyperparameter - Falses - Scheme A",
        "#falses",
        "falses_schemeA_1.png",
    )
